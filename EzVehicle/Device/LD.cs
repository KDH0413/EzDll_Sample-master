...
namespace EzVehicle.Device
{
    public class LD : IVehicle
    {
        ...
        public LD(string ip)
        {
            ...
            _beforeSt.state.st = eSTATE.ROBOT_LOST;
            _tReqStaus.Reset();
        }
        public bool Open()
        {
        ...
        private void On_RecvdData(object sender, string data)
        {
            ...
            switch (temp.cmd)
            {
                ...
                case eSTATE_CMD_TYPE.LOCATION: _curr.pos = new POS() { x = temp.pos.x, y = temp.pos.y, ang = temp.pos.ang }; break;
        ...
        {
            var jsonLog = JCVT_VEC.Set(new LOG() { bSend = bSend, msg = msg });
